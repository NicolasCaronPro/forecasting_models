...
class Model(BaseEstimator, ClassifierMixin, RegressorMixin):
    ...
    def fit(self, X, y, optimization='skip', grid_params=None, fit_params={}):
        ...
        if optimization == 'grid':
            ...
            grid_search = GridSearchCV(self.best_estimator_, grid_params, scoring=self.get_scorer(), cv=5)
    ...
    def plot_features_importance(self, X_set, y_set, names, outname, dir_output, mode = 'bar', figsize=(50,25)):
        """
